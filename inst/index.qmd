...
intro <- tryCatch(
    {
        description <- packageDescription("BiocBookTesting3")
...
👉 [ghcr.io/lmweber/biocbooktesting3](https://ghcr.io/lmweber/biocbooktesting3) 🐳
...
#| eval: false
docker run -it ghcr.io/lmweber/biocbooktesting3:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/lmweber/biocbooktesting3:devel
```
